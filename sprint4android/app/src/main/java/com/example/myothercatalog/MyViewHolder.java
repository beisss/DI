...
public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(@NonNull View itemView) {
        ...
        image = itemView.findViewById(R.id.pokemon_imageView);  // Asocia la ImageView
        text = itemView.findViewById(R.id.pokemon_textView);      // Asocia la TextView
    }

    // Método para mostrar datos en las vistas de la interfaz de usuario
    public void showData(MyItem data, Activity activity) {
